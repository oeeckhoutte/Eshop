...
class Category
{
     ...
     * Add product
     *
     * @param \EshopBundle\Entity\Product $product
     *
     * @return Category
     */
    public function addProduct(\EshopBundle\Entity\Product $product)
    {
     ...
     * @param \EshopBundle\Entity\Product $product
     */
    public function removeProduct(\EshopBundle\Entity\Product $product)
    {
